program exercise2
  ...
  real (kp) :: a, b, c
  real (kp) :: sum
  real (kp) :: conductance_fw, conductance_bw
  real (kp) :: delta
  ...
  conductance_fw = (4.0/3.0)*b*(c**3)*(1.0 - 6.0*(c/b)*sum)
  print *, "Approximation is: ", conductance_fw
  ...
  conductance_bw = (4.0/3.0)*b*(c**3)*(1.0 - 6.0*(c/b)*sum)
  print *, "Approximation is: ", conductance_bw

  delta = conductance_bw - conductance_fw
  
  print *, "Delta: ", delta
  print *, "Relative: ", delta / conductance_fw
