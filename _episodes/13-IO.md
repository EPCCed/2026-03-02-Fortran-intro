...
> 
> In the template [program1.f90](../exercises/13-IO/program1.f90), we establish a
...
> > ## Solution
> >
> > A [solution](../exercises/18-further-functions/pbm_image.f90) to this problem
> > appears in the later [episode on interfaces]({{ page.root }}{% link _episodes/18-further-functions.md %}).
> >
> > You should be able to produce an output PBM that looks like the example
> > shown below. 
> >
> > ![Sample PBM output.]({{ page.root }}/fig/test49-pbm.png)
> > 
> {: .solution}
{: .challenge}
